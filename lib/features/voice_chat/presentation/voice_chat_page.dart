          ...
          children: [
            ...
            ValueListenableBuilder<String>(
              ...
              builder: (context, lottieAsset, _) =>
                  SizedBox(height: 220, child: Lottie.asset(lottieAsset)),
            ),
            Padding(
            ...
            ValueListenableBuilder<String?>(
              ...
              builder: (context, feedback, _) {
                ...
                return Container(
                  ...
                  child: Text(feedback, style: const TextStyle(fontSize: 14)),
                );
              },
            ),
            ValueListenableBuilder<bool>(
                    ...
                    children: [
                      Expanded(
                        child: ElevatedButton.icon(
                          ...
                          icon: Icon(isPaused ? Icons.mic : Icons.pause),
                          label: Text(
                            isPaused
                                ? appText(context,
                                    en: 'Resume conversation',
                                    pt: 'Retomar conversa')
                                : appText(context, en: 'Pause', pt: 'Pausar'),
                          ),
                        ),
                      ),
                      const SizedBox(width: 10),
